...
class ScriptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create script" do
    assert_difference('Script.count') do
      post scripts_url, params: { script: { details: @script.details, doctor: @script.doctor, expiration: @script.expiration, user_id: @script.user_id } }
    end
  ...
  test "should update script" do
    patch script_url(@script), params: { script: { details: @script.details, doctor: @script.doctor, expiration: @script.expiration, user_id: @script.user_id } }
